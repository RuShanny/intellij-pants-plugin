 ...
 */
public class PantsModuleWizardStep extends ModuleWizardStep {
  private static final Icon WIZARD_ICON = null;

  private static final String INHERIT_GROUP_ID_KEY = "PantsModuleWizard.inheritGroupId";
  private static final String INHERIT_VERSION_KEY = "PantsModuleWizard.inheritVersion";
  ...
  @NotNull
  private final PantsModuleBuilder myBuilder;
  @NotNull
  ...
  public PantsModuleWizardStep(@NotNull PantsModuleBuilder builder, @NotNull WizardContext context) {
  ...
  public ProjectData findPotentialParentProject(@Nullable Project project) {
    ...
    final ExternalProjectInfo projectInfo =
      ProjectDataManager.getInstance().getExternalProjectData(project, PantsConstants.SYSTEM_ID, myContext.getProjectFileDirectory());
  ...
  private void updateComponents() {
    boolean isAddToVisible = !myContext.isCreatingNewProject() && myProjectOrNull != null && isPantsModuleExist();
    ...
    collapseIfPossible(myParentPathField, PantsConstants.SYSTEM_ID, getProject());
  ...
  private boolean isPantsModuleExist() {
    for (Module module : myContext.getModulesProvider().getModules()) {
      if (ExternalSystemApiUtil.isExternalSystemAwareModule(PantsConstants.SYSTEM_ID, module)) return true;
    }
    return false;
  }
